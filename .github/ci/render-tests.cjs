...
//
// `parse` reads the JSON shape Vitest emits with `--reporter=json`, which is
// the Jest shape. Only the unit suite runs here: the scenetest end-to-end
// scenes need a browser and a running server, so they stay out of this
// workflow.
